    ...
    <div class="row">
        <div class="span3">
            <div class="well" id="list_groups">
                ...
                <div class="wrap" id="groups" data-url="<?=URL::site('admin/group/getGroup')?>" style="height: 515px">
                    <?=View::factory('admin/html/groups_index', compact('groups'))?>
                </div>
            </div>
        </div>
        <form action="<?=URL::site('admin/group/edit')?>" method="post" accept-charset="utf-8" style="margin-bottom: 0" novalidate id="group_form">
