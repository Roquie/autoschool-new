    ...
    <div class="row">
        ...
        <div class="span3">
            <div class="well l_select_group">
                ...
                <a class="btn" href="<?=URL::site('admin/group')?>" rel="tooltip" title="Перейти на страницу добавления групп" data-toggle="modal" style="margin: -10px 0 0 0"><i class="icon-plus"></i></a>
