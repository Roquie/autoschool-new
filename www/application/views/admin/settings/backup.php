                                            ...
                                            <tbody style="height: 180px">
                                                <?$count = count($backup_files); foreach($backup_files as $k => $v):?>
                                                    <tr style="cursor: default; padding-top: 4px">
                                                        ...
                                                        <td style="line-height: 26px; width: 120px; padding-left: 40px; text-align: left">
                                                            <div class="btn-group" style="height: 25px">
                                                                <a class="btn btn-success" style="padding: 2px 10px 2px 10px;" href="<?=URL::site('backup_download/'.$filename)?>"><i class="icon-download"></i></a>
                                                                <a class="btn btn-danger" style="padding: 2px 10px 2px 10px;" href="<?=Request::current()->url().'?remove='.$filename.'&csrf='.bin2hex(Security::token())?>"><i class="icon-trash"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?endforeach?>
