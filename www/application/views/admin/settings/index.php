                ...
                <div class="span4">
                    <div class="well">
                        <form action="<?=Request::current()->url()?>" method="post" novalidate>
                            <legend>Номера для связи</legend>

                            <label for="telephone_1">Тел. 1</label>
                            <input name="telephone_1" type="text" class="input-block-level" id="telephone_1" value="<?=isset($data['telephone_1']) ? $data['telephone_1'] : null?>">

                            <label for="telephone_2">Тел. 2</label>
                            <input name="telephone_2" type="text" class="input-block-level" id="telephone_2" value="<?=isset($data['telephone_2']) ? $data['telephone_2'] : null?>">
