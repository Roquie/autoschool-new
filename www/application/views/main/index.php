...
<section class="row infoblocks">
    <div class="container">
        <h2>Преимуществом автошколы является работа опытных сотрудников – профессионалов, а так же реализована своя площадка в 30 метрах от учебного класса – автоподготовки. Обучение в городе происходит около здания МПТ,
            <a id="paractic_map" target="_blank" style="font-size: 18px" href="<?=URL::site('public/img/main/practic_map.png')?>" rel="tooltip" title="Открыть карту маршрута">в районе Нахимовского проспекта</a>.</h2>
        <div class="row">
            <div class="span3">
                <div class="grid">
