...
<div id="ptb">
  <ul id="ptb_toolbar" class="ptb_bg">
    <li class="info">
      ...
      /
      <a href="http://kohanaframework.org/" title="Go to kohana web site"><?php echo ProfilerToolbar::$kohana_version;?></a>
      <span class="icon" title="ProfilerToolbar v<?php echo ProfilerToolbar::$version;?> for Kohana v<?php echo ProfilerToolbar::$kohana_version;?>. Adapting by Invision (Invision70@gmail.com)"></span>
    </li>
